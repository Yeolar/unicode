...
std::string toLower(const String& str) {
  return toLower(acc::StringPiece(str));
}
...
std::string toUpper(const String& str) {
  return toUpper(acc::StringPiece(str));
}
...
std::string toOppositeCase(const String& str) {
  return toOppositeCase(acc::StringPiece(str));
}
...
std::string normalize(const String& str, NormalizationMode mode) {
  return normalize(acc::StringPiece(str), mode);
}
...
std::string asciify(const String& str) {
  return asciify(acc::StringPiece(str));
}
...
class Utf8Iterator
 ...
 public:
  ...
  acc::StringPiece piece() const {
    return acc::StringPiece(p_, utf8CodePointLength(p_));
  }
