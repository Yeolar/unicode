...
TEST(CharProperty, ucs2) {
  ...
  for (size_t i = 0; i < acc::size(hanzi_time); ++i) {
  ...
  for (size_t i = 0; i < acc::size(hanzi_digit); ++i) {
  ...
  for (size_t i = 0; i < acc::size(stop_punc); ++i) {
